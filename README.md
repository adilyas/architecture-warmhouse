...
- "Мониторинг температуры": Сбор данных с датчиков, отображение текущей температуры пользователям.
- "Управление пользователями": Регистрация, аутентификация и управление профилями пользователей.
- "Управление устройствами": Добавление, удаление и настройка датчиков температуры и других устройств.
